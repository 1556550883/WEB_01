package com.ruanyun.common.service;
 ...
 *  功能说明: service 基础处理类
 * 
 *  <br/>创建说明: 2013-8-26 下午02:26:28 yangliu  创建文件<br/>
 * 
 *  修改历史:<br/>
 *
 * 	@param <T>
...
public interface IBaseService<T> {
	 ...
	 * 降序
	 */
	public static final String ORDER_DESC=ICommonHqlDao.ORDER_DESC;
	/**
	 * 升序
	 */
	public static final String ORDER_ASC=ICommonHqlDao.ORDER_DESC;
