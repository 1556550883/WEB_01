...
(function () {
   ...
   // alert(projectName);
     ...
     * window.UEDITOR_HOME_URL = "/xxxx/xxxx/";getUEBasePath()
     */
	
    var URL = window.UEDITOR_HOME_URL || projectName+'/ueditor/';
    //URL="/WEB-INF/jsp/ueditor";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imageUrl:"/ahsw/ueditor/uploageImage" 
        ,imagePath:localhostPaht+projectName+"/"  //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置 
...
//
//        //图片在线管理配置区
//        ,imageManagerUrl:URL + "/WEB-INF/jsp/ueditor/imageManager.jsp"       //图片在线管理的处理地址
...
//        //,videoFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
        ...
        /*, toolbars:[
           ...
           * 
           * LHT自定义  工具栏
           * 去除了｛'scrawl':'涂鸦','music':'音乐','gmap':'Google地图','insertcode':'代码语言','webapp':'百度应用',
           *         'background':'背景','snapscreen':'截图','wordimage':'图片转存','drafts': '从草稿箱加载', 'charts': '图表',
           *         'insertvideo':'视频','attachment':'附件','help':'帮助',｝
           */
		 , toolbars:[
		             ['fullscreen', 'source', '|', 'undo', 'redo', '|',
		                 'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
		                 ...
		                 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|',
		                 'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
		                 'insertimage', 'emotion', 'map', 'insertframe','pagebreak', 'template', '|',
