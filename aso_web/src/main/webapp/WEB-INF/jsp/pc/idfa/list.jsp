...
<ry:binding parentCode="CHANNEL_NUM" bingdingName="channelNum"></ry:binding>
...
<form id="pagerForm" method="post" action="channelInfo/idfaStatistics">
...
<div class="pageHeader">
	<form rel="pagerForm" id="selForm" onsubmit="return navTabSearch(this);" action="channelInfo/idfaStatistics" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>					
						渠道：
						<select name="channelNum">
		                   <c:forEach items="${channelNum}" var="item">
		                          <option value="${item.itemCode}" <c:if test="${adverInfo.channelNum == item.itemCode}">selected</c:if> >${item.itemName}</option>
		                   </c:forEach>
		                </select>
					</td>
					<td>完成日期：
	...
	<table class="table" width="100%" layoutH="128">
		<thead>
			<tr class="header">
				...
				<th align="center" width="100px;">手机操作系统</th>
				<th align="center" width="100px;">广告ID</th>
				<th align="center" width="300px;">广告名称</th>
